  ...
  return (
    <div className="hero min-h-[400px] bg-gradient-to-r from-pink-100 to-rose-200 p-4 shadow-lg">
      <div className="hero-content flex flex-col lg:flex-row-reverse gap-8 items-stretch">
        ...
        {/* Toy Info Section */}
        <div className="flex-1 w-full lg:w-1/2 flex flex-col justify-between bg-base-100 p-6 rounded-lg shadow-lg">
          <div>
            {/* Toy Name */}
            ...
            {/* Rating & Availability */}
            <div className="flex flex-wrap justify-between items-center text-base-content mb-3">
              {/* Rating */}
              <div className="flex items-center gap-1">
                <span className="font-semibold text-[#EB1551] mr-1">
                  Rating:
                </span>
                <div className="flex">
                  {Array.from({ length: 5 }).map((_, index) => {
                    const starValue = index + 1;
                    if (toy.rating >= starValue) {
                      return <FaStar key={index} className="text-yellow-400" />;
                    } else if (toy.rating >= starValue - 0.5) {
                      return (
              ...
              <p className="text-base sm:text-lg">
                <span className="font-semibold text-[#EB1551]">Available:</span>{" "}
            ...
            <div className="flex flex-wrap justify-center gap-4 my-3 items-center">
              <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#EB1551] to-[#FF5FA8]">
                Price:
              </span>
